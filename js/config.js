// ============================================================
// CONFIG.JS - Firebase Configuration & External Links
// ============================================================
...
// ============================================================
// GOOGLE DOCS LINKS (Print Documents)
// ============================================================
...
// ============================================================
// DOKUMENTASI FOTO LINKS (Google Drive)
// ============================================================
...
// ============================================================
// EXPORT KE WINDOW (untuk akses dari HTML onclick)
// ============================================================
window.googleDocsLinks = googleDocsLinks;
window.dokumentasiLinks = dokumentasiLinks;

// ============================================================
// HELPER FUNCTION - Get Link berdasarkan tipe
// ============================================================
export function getDocumentLink(type) {
  return googleDocsLinks[type] || '#';
}

export function getDokumentasiLink(type) {
  return dokumentasiLinks[type] || '#';
}